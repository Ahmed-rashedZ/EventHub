...
class AgreementWordService
{
    ...
    public static function generateExhibition($exhibitionApplication): string
    {
        ...
        $booth   = $exhibitionApplication->booth;
        $date    = now()->format('Y-m-d');
        ...
        $details = [
            ...
            ['حجم الجناح المفضل', $exhibitionApplication->booth_preference ?? '—'],
        ];

        // Add booth details if assigned
        if ($booth) {
            $details[] = ['رقم الجناح', $booth->booth_number ?? '—'];
            $details[] = ['حجم الجناح', $booth->booth_size ?? '—'];
            $details[] = ['رسوم الجناح', ($booth->booth_fee ?? 0) . ' ريال'];
        }
        ...
        $clauses = [
            ...
            ['title' => 'البند الثالث: تجهيزات الجناح', 'content' => '', 'editable' => "١. التجهيزات المقدمة من المنظم:\n_______________________________________________\n٢. التجهيزات المطلوبة من الشركة:\n_______________________________________________\n٣. _______________________________________________"],
            ['title' => 'البند الرابع: التزامات الشركة العارضة', 'content' => '', 'editable' => "١. الالتزام بمواعيد التواجد في الجناح.\n٢. توفير المواد الترويجية والعينات.\n٣. الالتزام بالأنظمة واللوائح المعمول بها.\n٤. _______________________________________________"],
            ['title' => 'البند الخامس: التزامات المنظم', 'content' => '', 'editable' => "١. توفير الجناح المخصص بالمواصفات المتفق عليها.\n٢. توفير الخدمات الأساسية (كهرباء، إنترنت، تنظيف).\n٣. إدراج الشركة في الدليل الرسمي للمعرض.\n٤. _______________________________________________"],
