...
<div class="auth-page">
  ...
  <div class="auth-card">
    ...
    <div style="margin-top: 24px; text-align: left;">
      <div class="card" style="padding: 16px; margin-bottom: 16px; background: rgba(59,130,246,0.1); border: 1px solid var(--primary);">
      ...
      <div class="card" style="padding: 16px; background: rgba(16,185,129,0.1); border: 1px solid var(--success);">
        ...
        <p style="margin: 0; font-size: 0.85rem; color: var(--text-secondary);">Accounts for Event Managers and Sponsors must be created by the System Administrator.</p>
      </div>
    </div>
