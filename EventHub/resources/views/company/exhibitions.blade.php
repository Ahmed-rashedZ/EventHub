    ...
    Promise.all([
      ...
      if (myApp) {
          ...
          if (myApp.status === 'pending') {
              ...
              statusActions = `<div style="margin-top:10px;"><button class="btn btn-primary btn-sm" onclick="closeEventDetailsModal(); openAgreementModal(${myApp.id}, 'exhibition')">${t('Review Contract')}</button></div>`;
