...
const I18N_EN = {
  ...
  /* ── Event Type: Arabic DB values → English display ── */
  'معرض': 'Exhibition',
  'مؤتمر': 'Conference',
  'ندوة': 'Seminar',
  'ورشة عمل': 'Workshop',
  ...
  'Edit Event Agenda': 'Edit Event Agenda',
  'Start time must be between': 'Start time must be between',
  'End time must be between': 'End time must be between',
  'and': 'and',
  'Product Category': 'Product Category',
  'e.g. Technology, Food, Education...': 'e.g. Technology, Food, Education...',
  '(Required)': '(Required)',
  ' (Required)': ' (Required)',
  'Define the schedule/program for your event. You must add at least one agenda item.': 'Define the schedule/program for your event. You must add at least one agenda item.',
  'Change Booth': 'Change Booth',
  'Confirmed': 'Confirmed',
  'Booth': 'Booth',
  'Booth deleted': 'Booth deleted',
  'Created': 'Created',
  'Updated': 'Updated',
  'Zone created': 'Zone created',
  'Booths generated': 'Booths generated',
  'Loading booths...': 'Loading booths...',
  'Error loading': 'Error loading',
  '-- Select Booth --': '-- Select Booth --',
  'No size': 'No size',
  'Booth assigned successfully!': 'Booth assigned successfully!',
  'Error assigning booth': 'Error assigning booth',
  ...
  'لا يمكنك إرسال طلبات رعاية لأن بعض وثائقك مرفوضة أو غير معتمدة. يرجى مراجعة حالة وثائقك.': 'You cannot send sponsorship requests because some of your documents are rejected or not approved. Please check your document status.',
  'لا يمكنك إرسال دعوات لأن بعض وثائقك مرفوضة أو غير معتمدة. يرجى مراجعة حالة وثائقك.': 'You cannot send invitations because some of your documents are rejected or not approved. Please check your document status.',
  'لا يمكن دعوة هذا الراعي لأن وثائقه غير معتمدة بالكامل.': 'Cannot invite this sponsor because their documents are not fully approved.',
  'لا يمكن دعوة هذه الشركة لأن وثائقها غير معتمدة بالكامل.': 'Cannot invite this company because their documents are not fully approved.',
  'لا يمكنك التقديم على المعارض لأن بعض وثائقك مرفوضة أو غير معتمدة. يرجى مراجعة حالة وثائقك.': 'You cannot apply for exhibitions because some of your documents are rejected or not approved. Please check your document status.',
};
...
const I18N_AR = {
  ...
  'Approve': 'اعتماد',
  'admin': 'الأدمن',
  'Applications can only be submitted for approved events': 'لا يمكن تقديم الطلبات إلا للمعارض المعتمدة',
  'Downloading contract...': 'جاري تحميل العقد...',
  'Error downloading contract': 'خطأ في تحميل العقد',
  'Your updated documents have been approved: ': 'تم تحديث مستند معتمد: ',
  ...
  'New Partner Registration': 'تسجيل شريك جديد',
  ...
  'Description': 'الوصف',
  'Briefly describe your event…': 'صف الفعالية باختصار…',
  'Event Banner Image': 'صورة الغلاف للفعالية',
  'Continue →': 'متابعة ←',
  'Venue & Schedule': 'القاعة والجدول الزمني',
  'Event Venue': 'مكان الفعالية',
  ...
  '📅 Select Event Days': '📅 اختر أيام الفعالية',
  ...
  'Event Objective': 'الهدف من الفعالية',
  'What is the main goal of this event?': 'ما هو الهدف الرئيسي من هذه الفعالية؟',
  ...
  'Exhibition': 'معرض',
  'Exhibition features (booths, company applications, and contracts) will be enabled for this event.': 'ستفعل مميزات المعرض (إدارة الأجنحة، طلبات الشركات، والاتفاقيات) لهذه الفعالية.',
  'Required. Upload the official approval from the relevant competent authority for this event.': 'مطلوب. يرجى رفع الموافقة الرسمية من الجهة المختصة ذات العلاقة بهذه الفعالية.',
  'Event Agenda': 'أجندة الفعالية',
  'Edit Agenda': 'تعديل الأجندة',
  'Save Agenda': 'حفظ الأجندة',
  'Agenda saved successfully!': 'تم حفظ الأجندة بنجاح!',
  '(Required)': '(مطلوب)',
  'Define the schedule/program for your event. You must add at least one agenda item.': 'حدد البرنامج/الجدول الزمني للفعالية. يجب إضافة بند واحد على الأقل في الأجندة.',
  ...
  'Search by event name...': 'ابحث باسم الفعالية...',
  ...
  'Capacity': 'السعة',
  'Event Agenda': 'أجندة الفعالية',
  'Edit Event Agenda': 'تعديل أجندة الفعالية',
  'Start time must be between': 'وقت البدء يجب أن يكون بين',
  'End time must be between': 'وقت الانتهاء يجب أن يكون بين',
  'and': 'و',
  'Product Category': 'فئة المنتج / الخدمة',
  'e.g. Technology, Food, Education...': 'مثال: تقنية، أغذية، تعليم...',
  '(Required)': '(مطلوب)',
  ' (Required)': ' (مطلوب)',
  'Define the schedule/program for your event. You must add at least one agenda item.': 'حدد البرنامج/الجدول الزمني للفعالية. يجب إضافة بند واحد على الأقل في الأجندة.',
  'Add Agenda Item': 'إضافة بند للأجندة',
  ...
  'Mar': 'مارس',
  'Apr': 'أبريل',
  'Approve, reject and monitor all events': 'الموافقة على الفعاليات أو رفضها ومراقبتها',
  'Search by event or manager name...': 'ابحث عن طريق اسم الفعالية أو المنظم...',
  ...
  'The event is already sold out and cannot be cancelled at this stage...': 'الفعالية بيعت تذاكرها بالكامل ولا يمكن إلغاؤها في هذه المرحلة...',
  ...
  'The following events are already booked in this date range:': 'الفعاليات التالية محجوزة بالفعل في هذا النطاق الزمني:',
  ...
  'Event has ended': 'الفعالية انتهت',
  'Event is live': 'الفعالية مباشرة الآن',
  'Needs Approval': 'يحتاج إلى موافقة',
  'Event must be approved first': 'يجب الموافقة على الفعالية أولاً',
  'Cannot change sponsorship for live/ended events': 'لا يمكن تغيير الرعاية للفعاليات المباشرة/المنتهية',
  ...
  'You are visible to event managers who may invite you to exhibitions.': 'أنت مرئي لمدراء الفعاليات الذين قد يدعونك للمعارض.',
  ...
  'Discover opportunities to exhibit at upcoming verified events': 'اكتشف فرص العرض في الفعاليات القادمة المعتمدة',
  ...
  'You are currently not visible to event managers.': 'أنت غير مرئي لمدراء الفعاليات حالياً.',
  ...
  'Application sent directly to Event Manager!': 'تم إرسال الطلب مباشرة لمدير الفعالية!',
  ...
  /* ── Notification message phrases (partial) ── */
  'booked a ticket for': 'حجز تذكرة لـ',
  'sent a sponsorship request for': 'أرسل طلب رعاية لـ',
  'You received a sponsorship invitation for': 'تلقيت دعوة رعاية للفعالية',
  'has accepted your sponsorship invitation for': 'قبل دعوة رعايتك للفعالية',
  ...
  ' pending': ' قيد الانتظار',
  ' rejected': ' مرفوض',
  ' of all events': ' من إجمالي الفعاليات',
  ' checked in': ' حاضر',
  ' checked in out of ': ' حاضر من أصل ',
  ...
  /* ── Sponsor Visibility ───────────────────────────────── */
  'You are currently not visible to event managers.': 'أنت غير مرئي لمديري الفعاليات حالياً.',
  'You will remain hidden until you turn this option ON again.': 'ستبقى مخفياً حتى تعيد تفعيل هذا الخيار.',
  ...
  'Top Events by Registrations': 'أفضل الفعاليات حسب التسجيل',
  'Event': 'الفعالية',
  'Type': 'النوع',
  'Tickets': 'التذاكر',
  'Users by Role': 'المستخدمون حسب الدور',
  'Pending Approvals': 'موافقات قيد الانتظار',
  'No pending events': 'لا توجد فعاليات قيد الانتظار',
  'No approved events yet': 'لا توجد فعاليات معتمدة بعد',
  'No events yet. Create one!': 'لا توجد فعاليات بعد. أنشئ فعالية!',
  ...
  'When enabled, your profile will be listed publicly, and Event Managers can send you sponsorship requests. You can also browse and request to sponsor published events.': 'عند التفعيل، سيتم إدراج ملفك الشخصي للعامة، ويمكن لمديري الفعاليات إرسال طلبات رعاية إليك. يمكنك أيضًا تصفح طلبات رعاية الفعاليات المنشورة.',
  ...
  'Security settings updated successfully!': 'تم تحديث إعدادات الأمان بنجاح!',
  'Sponsor rank updated successfully': 'تم تحديث تصنيف الراعي بنجاح',
  'Booth information updated successfully': 'تم تحديث معلومات الجناح بنجاح',
  'Rating submitted successfully': 'تم تقديم التقييم بنجاح',
  'Rating deleted successfully': 'تم حذف التقييم بنجاح',
  'Review sent successfully': 'تم إرسال المراجعة بنجاح',
  'Event updated successfully': 'تم تحديث الفعالية بنجاح',
  'Agenda updated successfully': 'تم تحديث الأجندة بنجاح',
  'Event cancelled successfully': 'تم إلغاء الفعالية بنجاح',
  'Profile updated successfully': 'تم تحديث الملف الشخصي بنجاح',
  'User created successfully': 'تم إنشاء المستخدم بنجاح',
  'Assistant updated successfully': 'تم تحديث المساعد بنجاح',
  'Assistant deleted successfully': 'تم حذف المساعد بنجاح',
  'Invitation accepted successfully': 'تم قبول الدعوة بنجاح',
  'Invitation sent successfully': 'تم إرسال الدعوة بنجاح',
  'Invitation cancelled successfully': 'تم إلغاء الدعوة بنجاح',
  'Agreement cancelled successfully': 'تم إلغاء الاتفاقية بنجاح',

  /* ── Event Stats Page ──────────────────────────────────── */
  'Event Statistics - EventHub Manager': 'إحصائيات الفعالية - EventHub',
  ...
  'No reviews yet for this event': 'لا توجد مراجعات لهذه الفعالية بعد',
  'Anonymous': 'مجهول',
  ...
  'Real-time attendance tracking for your live events': 'تتبع الحضور في الوقت الفعلي لفعالياتك',
  'Create accounts for assistants to scan QR codes at your events': 'إنشاء حسابات للمساعدين لفحص رموز QR في فعالياتك',
  'Venues': 'القاعات',
  'Manage event locations': 'إدارة مواقع الفعاليات',
  ...
  'Locked (Started)': 'مغلق (بدأت الفعالية)',
  ...
  'This tier will be updated immediately in all event details.': 'سيتم تحديث هذا المستوى فوراً في تفاصيل الفعالية.',
  '💎 Diamond': '💎 ماسي',
  '🥇 Gold': '🥇 ذهبي',
  '🥈 Silver': '🥈 فضي',
  '🥉 Bronze': '🥉 برونزي',

  /* ── Sponsorship Controller Errors & Ranks ──────────────── */
  'Registration cannot be opened. The 30-day deadline before the event has passed.': 'لا يمكن فتح التسجيل. لقد مضى الموعد النهائي (30 يوماً) قبل الفعالية.',
  'Cannot open sponsorship for an event that is not approved.': 'لا يمكن فتح الرعاية لفعالية غير مقبولة.',
  'This event is not an exhibition': 'هذه الفعالية ليست معرضاً',
  'Cannot toggle registration for an event that is not approved.': 'لا يمكن تبديل حالة التسجيل لفعالية غير مقبولة.',
  'Cannot toggle applications for an event that is not approved.': 'لا يمكن تبديل حالة الطلبات لفعالية غير مقبولة.',
  'Only attendees can book tickets': 'يمكن للحضور فقط حجز التذاكر',
  'Event is not available for booking': 'الفعالية غير متاحة للحجز حالياً',
  'Ticket sales are currently suspended for this event.': 'مبيعات التذاكر معلقة حالياً لهذه الفعالية.',
  'You already have a ticket for this event': 'لديك بالفعل تذكرة لهذه الفعالية',
  ...
  'Exhibition layout is locked (Less than 14 days remaining). You can no longer add, edit, or delete zones and booths.': 'مخطط المعرض مغلق (متبقي أقل من 14 يوماً). لم يعد بإمكانك إضافة أو تعديل أو حذف المناطق والمنصات.',
  'Sponsorships can only be created for approved events': 'يمكن إنشاء الرعايات فقط للفعاليات المقبولة',
  'Sponsor is not available': 'الراعي غير متاح حالياً',
  'A sponsorship request already exists between this event and sponsor': 'يوجد بالفعل طلب رعاية بين هذه الفعالية والراعي',
  'You must be available to send requests': 'يجب أن تكون متاحاً لإرسال الطلبات',
  'This event is currently closed to new sponsorship requests.': 'هذه الفعالية مغلقة حالياً أمام طلبات الرعاية الجديدة.',
  'You have already sent a request for this event': 'لقد أرسلت بالفعل طلباً لهذه الفعالية',
  'Only the Event Manager can respond to this request': 'يمكن لمدير الفعالية فقط الرد على هذا الطلب',
  'Only the Sponsor can respond to this request': 'يمكن للراعي فقط الرد على هذا الطلب',
  'Not your request': 'هذا الطلب ليس لك',
  'Can only update tier for accepted sponsorships': 'يمكن فقط تحديث المستوى للرعايات المقبولة',
  'Diamond': 'ماسي',
  'Gold': 'ذهبي',
  'Silver': 'فضي',
  'Bronze': 'برونزي',
  'This rank (': 'هذا التصنيف (',
  ') is already assigned to another sponsor for this event. Please select an available rank.': ') تم تعيينه بالفعل لراعٍ آخر في هذه الفعالية. يرجى اختيار تصنيف متاح.',
  'You are now visible.': 'أنت الآن مرئي.',
  'You are now hidden.': 'أنت الآن مخفي.',
  'You are now visible to managers.': 'أنت الآن مرئي للمنظمين.',
  'Decline': 'رفض',
  ...
  'Received': 'الواردة',
  'Sent': 'الصادرة',
  'Awaiting Manager': 'بانتظار المدير',
  'Sponsorship accepted! 🎉': 'تم قبول الرعاية! 🎉',
  'Request declined.': 'تم رفض الطلب.',
  'Error': 'خطأ',
  'Msg': 'الرسالة',
  'View Message': 'عرض الرسالة',
  'From Event Manager': 'من مدير الفعالية',
  'From You': 'منك',
  'No message provided.': 'لا يوجد رسالة.',
  'Got it': 'حسناً',
  ...
  'Invite available assistants to your events and track their performance': 'قم بدعوة المساعدين المتاحين لفعالياتك وتتبع أدائهم',
  '📨 Invite Assistants': '📨 دعوة المساعدين',
  'Browse available assistants and send event invitations': 'تصفح المساعدين المتاحين وأرسل دعوات الفعالية',
  'Select Event to Invite For': 'اختر الفعالية للدعوة إليها',
  'Choose an event...': 'اختر فعالية...',
  'Search assistants...': 'البحث عن المساعدين...',
  'Select an event first to see available assistants': 'اختر فعالية أولاً لرؤية المساعدين المتاحين',
  'All': 'الكل',
  ...
  'Remove Assistant': 'إزالة المساعد',
  'Please select an event first': 'يرجى اختيار فعالية أولاً',
  'this event': 'هذه الفعالية',
  ...
  'Scans': 'عمليات المسح',
  'Remove': 'إزالة',
  'Cannot remove from ended event': 'لا يمكن الإزالة من فعالية منتهية',
  'Are you sure you want to remove this assistant from the event?': 'هل أنت متأكد من إزالة هذا المساعد من الفعالية؟',
  ...
  'Search by event or manager name...': 'البحث باسم الفعالية أو مديرها...',
  'Search by event name...': 'البحث باسم الفعالية...',
  'Search by name or manager...': 'البحث بالاسم أو المدير...',
  ...
  'Untitled Event': 'فعالية غير معنونة',
  '⏳ Awaiting Event Manager to respond': '⏳ بانتظار رد مدير الفعالية',
  'Awaiting Event Manager to respond': 'بانتظار رد مدير الفعالية',
  'Sponsorship accepted! 🎉': 'تم قبول الرعاية! 🎉',
  'Sponsorship accepted!': 'تم قبول الرعاية!',
  'Request declined.': 'تم رفض الطلب.',
  ...
  'You are currently visible to event managers and can browse opportunities.': 'أنت مرئي حالياً لمديري الفعاليات ويمكنك تصفح الفرص.',
  'Available': 'متاح',
  ...
  'Sponsorship History': 'سجل الرعايات',
  'Your portfolio of supported events and their performance': 'محفظتك للفعاليات المدعومة وأدائها',
  'Events Sponsored': 'الفعاليات المدعومة',
  'Total Attendees': 'إجمالي الحضور',
  'Failed to load data': 'فشل تحميل البيانات',
  "You haven't sponsored any events yet.": 'لم تقم برعاية أي فعاليات بعد.',
  ...
  'e.g. Tech Summit 2026': 'مثال: قمة التقنية 2026',
  'Description': 'الوصف',
  'Describe your event…': 'صف فعاليتك...',
  'Briefly describe your event…': 'صف فعاليتك باختصار...',
  ...
  'Event Banner Image': 'صورة غلاف الفعالية',
  'Submit for Approval': 'إرسال للاعتماد',
  ...
  'Sponsorship is now OPEN for this event.': 'الرعاية الآن مفتوحة لهذه الفعالية.',
  'Sponsorship is now CLOSED for this event.': 'الرعاية الآن مغلقة لهذه الفعالية.',
  'Exhibitor registration is now OPEN.': 'تسجيل العارضين مفتوح الآن.',
  'Exhibitor registration is now CLOSED.': 'تسجيل العارضين مغلق الآن.',
  'Registration toggled ON, but it remains inactive due to the 60-day deadline.': 'تم تفعيل التسجيل، ولكنه يظل غير نشط بسبب مهلة الـ 60 يوماً.',
  'Event deleted successfully': 'تم حذف الفعالية بنجاح',
  'Error deleting event': 'حدث خطأ أثناء حذف الفعالية',
  'Are you sure you want to delete this event? This action cannot be undone.': 'هل أنت متأكد من رغبتك في حذف هذه الفعالية؟ لا يمكن التراجع عن هذا الإجراء.',
  'No applications yet.': 'لا توجد طلبات تقديم بعد.',
  'No applications yet': 'لا توجد طلبات تقديم بعد.',
  'Error updating status': 'حدث خطأ أثناء تحديث الحالة',
  'Event submitted for approval!': 'تم إرسال الفعالية للاعتماد!',
  'Could not fetch event details': 'تعذر استرجاع تفاصيل الفعالية',
  'Could not load details': 'تعذر تحميل التفاصيل',
  'No description.': 'لا يوجد وصف.',
  'Average Event Rating': 'متوسط تقييم الفعاليات',
  ...
  'Error saving agenda': 'خطأ في حفظ الأجندة',
  ...
  'New Ticket Booked 🎟️': 'تم حجز تذكرة جديدة',
  'New Ticket Booked': 'تم حجز تذكرة جديدة',
  ...
  'Invitation rejected': 'تم رفض الدعوة',
  'Invitation': 'دعوة',
  'Request sent directly to Event Manager!': 'تم إرسال الطلب مباشرة لمدير الفعالية!',
  'Error sending request': 'خطأ في إرسال الطلب',
  'All notifications marked as read': 'تم تعليم جميع الإشعارات كمقروءة',
  'The password field confirmation does not match.': 'تأكيد كلمة المرور لا يتطابق.',
  'The password field confirmation does not match': 'تأكيد كلمة المرور لا يتطابق',

  /* ── Auth / Login / Registration messages ── */
  'Email Address is already taken': 'البريد الإلكتروني مأخوذ بالفعل',
  'Invalid credentials': 'بيانات الدخول غير صحيحة',
  'Your account has been suspended. Please contact support at support@eventhub.com': 'تم تعليق حسابك. يرجى التواصل مع الدعم عبر support@eventhub.com',
  'This account is for the mobile app only. You cannot log in via the web.': 'هذا الحساب مخصص لتطبيق الهاتف فقط، لا يمكنك تسجيل الدخول عبر الويب.',
  'Web accounts cannot log in via the mobile app.': 'حسابات الويب لا يمكنها تسجيل الدخول عبر تطبيق الهاتف.',
  'Contact Support': 'تواصل مع الدعم',
  'Email copied to clipboard': 'تم نسخ البريد الإلكتروني بنجاح',
  'Commercial Register is required': 'السجل التجاري مطلوب',
  'Tax Number Certificate is required': 'شهادة الرقم الضريبي مطلوبة',
  'Articles of Association is required': 'النظام الأساسي مطلوب',
  'Practice License is required': 'رخصة الممارسة مطلوبة',
  'The file must be of a valid type': 'يجب أن يكون الملف من نوع صالح',
  'The file must be of type: pdf, jpg, jpeg, png': 'يجب أن يكون الملف من نوع: pdf, jpg, jpeg, png',
  'Files must not exceed 5 MB': 'يجب ألا تتجاوز الملفات 5 ميغابايت',
  'Registration successful! Redirecting...': 'تم التسجيل بنجاح! جارٍ التحويل...',
  'Please enter the other category': 'يرجى كتابة الفئة الأخرى',
  ...
  'Company Sector / Category': 'قطاع الشركة / الفئة',
  ...
  '🔄 Refresh': '🔄 تحديث',
  'Refresh': 'تحديث',
  ' Live Events': ' فعاليات مباشرة',
  ' Live Event': ' فعالية مباشرة',
  'Edit Profile': 'تعديل الملف الشخصي',
  'No bio provided yet.': 'لم يتم تقديم نبذة بعد.',
  'End': 'وقت الانتهاء',

  /* ── Event Stats ──────────────────────────────────────── */
  '← Back to My Events': '← الرجوع إلى فعالياتي',
  'Capacity': 'السعة',
  'Max attendees': 'الحد الأقصى للحضور',
  'Registered': 'المسجلون',
  'Checked In': 'تم الحضور',
  ...
  'Reviews & Ratings': 'التقييمات والمراجعات',
  'No ratings yet': 'لا توجد تقييمات بعد',
  'No reviews yet for this event': 'لا توجد مراجعات لهذه الفعالية',
  'Failed to load reviews': 'فشل تحميل التقييمات',
  'Anonymous': 'مجهول',
  'No written review': 'لا توجد مراجعة مكتوبة',
  ...
  'Open Ticket Sales': 'فتح مبيعات التذاكر',
  'Request Cancellation': 'طلب إلغاء الفعالية',
  'Contract Negotiation': 'تفاوض على العقد',
  'Final Agreement': 'الاتفاقية النهائية',
  'Downloading agreement...': 'جاري تحميل الاتفاقية...',
  'Error downloading agreement': 'خطأ أثناء تحميل الاتفاقية',
  '🛑 Close Ticket Sales': '🛑 إغلاق مبيعات التذاكر',
  ...
  'e.g. The event is already sold out and cannot be cancelled at this stage...': 'مثال: الفعالية بيعت تذاكرها بالكامل ولا يمكن إلغاؤها في هذه المرحلة...',
  'Confirm Rejection': 'تأكيد الرفض',
  ...
  'Accounts for Event Managers and Sponsors must be verified by the System Administrator.': 'يجب التحقق من حسابات مديري الفعاليات والرعاة من قبل مدير النظام.',
  ...
  'Sign in here': 'سجّل الدخول هنا',
  'Partner Registration': 'تسجيل الشركاء',
  'Apply as an Event Manager or Sponsor.': 'التقديم كمدير فعاليات أو راعٍ.',
  ...
  /* ── Attendance Page ────────────────────────────────────── */
  'No Live Events': 'لا توجد فعاليات مباشرة',
  "You don't have any events that are currently live.": 'ليس لديك أي فعاليات مباشرة حالياً.',
  'Events will appear here during their scheduled time.': 'ستظهر الفعاليات هنا خلال وقتها المحدد.',
  ...
  'Document update reviewed successfully.': 'تمت مراجعة تحديث المستند بنجاح.',
  'Pending Review': 'قيد المراجعة',
  ...
  'verified': 'موثق',
  'Pending Review': 'قيد المراجعة',
  'Pending Update': 'تحديث معلق',
  'Document Problem': 'مشكلة في الوثائق',
  ...
  'N/A': 'غير متوفر',
  'Sponsor tier updated beautifully!': 'تم تحديث باقة الراعي بنجاح!',
  ...
  'rejected': 'مرفوض',
  'of all events': 'من جميع الفعاليات',
  ...
  'Zones & Booths Configuration': 'إعداد المناطق والأجنحة',
  'Manage exhibition zones and available slots': 'إدارة مناطق المعرض والفتحات المتاحة',
  'Add Zone': 'إضافة منطقة',
  'Add New Zone': 'إضافة منطقة جديدة',
  'Zone Name': 'اسم المنطقة',
  'Create Zone': 'إنشاء المنطقة',
  'Assign Booth': 'تعيين جناح',
  'Assign Booth Location': 'تخصيص مكان الجناح',
  'Select Booth': 'اختر الجناح',
  'Save Assignment': 'حفظ التخصيص',
  'Add Booth': 'إضافة جناح',
  'Edit Booth': 'تعديل جناح',
  'Booth Number': 'رقم الجناح',
  'Batch Add': 'إضافة اجنحه ',
  'Batch Generate Booths': 'توليد أجنحة ',
  'How many?': 'كم العدد؟',
  'Default Size': 'الحجم الافتراضي',
  'Generate Batch': 'توليد أجنحة',
  'No zones defined yet.': 'لا توجد مناطق محددة بعد.',
  'Create First Zone': 'إنشاء أول منطقة',
  ...
  'Zone created': 'تم إنشاء المنطقة',
  'Booths generated': 'تم توليد الأجنحة',
  'Loading booths...': 'جاري تحميل الأجنحة...',
  'Error loading': 'خطأ في التحميل',
  '-- Select Booth --': '-- اختر جناح --',
  'No size': 'بدون حجم',
  'Booth assigned successfully!': 'تم تعيين الجناح بنجاح!',
  'Error assigning booth': 'خطأ في تعيين الجناح',
  ...
  'New ticket purchase for "': 'شراء تذكرة جديدة للفعالية "',
  '" (': '" (',
  ' tickets).': ' تذاكر).',
  ...
  'Your sponsorship request for "': 'طلب الرعاية الخاص بك للفعالية "',
  '" has been accepted.': '" تم قبوله.',
  '" has been rejected.': '" تم رفضه.',
  ...
  'Sponsored': 'المدعومة',
  'Sponsored Events History': 'سجل الفعاليات المدعومة',
